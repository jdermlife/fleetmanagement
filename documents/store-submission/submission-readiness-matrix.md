...
| Data safety draft | Amber | Product / Legal / Engineering | Final Play Console answers approved by product/legal | Draft and evidence templates are in `documents/store-submission/google-play-console-answers-draft.md`, `documents/release-evidence/data-safety-final-answers.md`, and `documents/store-submission/gp03-gp04-stakeholder-signoff-pack.md` | Yes | Complete console entry and capture approved evidence |
| Public privacy policy URL | Green | Product / Web / Legal | Public live privacy-policy URL | Live URL is deployed and referenced in `frontend/store-metadata.template.json` | No | Keep URL stable and monitored |
| Support URL and contact metadata | Green | Product / Ops | Public support URL and verified contact workflow | Live URL is deployed and referenced in `frontend/store-metadata.template.json` | No | Confirm support response process remains active |
...
| Legal/privacy alignment | Amber | Legal / Product / Engineering | Final legal sign-off on privacy and terms | Public legal pages are deployed; final legal sign-off evidence is still pending | Yes | Complete legal sign-off and archive evidence |
...
2. TestFlight build
3. Real-device QA evidence
4. Reviewer/demo account validation evidence
