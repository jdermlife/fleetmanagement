...
export default function NetWorthPositioningPage() {
  ...
  const alwaysVisibleSetupRows = useMemo(
    () => setupRows.slice(0, INITIAL_VISIBLE_SETUP_ROWS),
    [setupRows],
  );

  const accordionSetupRows = useMemo(
    () => setupRows.slice(INITIAL_VISIBLE_SETUP_ROWS),
    [setupRows],
  );
  ...
  return (
    <div className="psychometric-page networth-dashboard-page">
      <section className="psychometric-hero networth-dashboard-hero">
        ...
        The Net Worth Positioning Score is based on the variance of actual values versus setup values.  The score is a measure of how well you are positioned to achieve your financial goals.                     <a
