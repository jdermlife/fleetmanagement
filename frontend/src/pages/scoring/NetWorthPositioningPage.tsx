...
export default function NetWorthPositioningPage() {
  ...
  const categoryFilterOptions = useMemo(() => {
    const scopedRows = selectedSetupSection === 'all'
      ? setupRows
      : setupRows.filter((row) => row.section === selectedSetupSection);
  ...
  const filteredSetupRows = useMemo(() => {
    ...
    return setupRows.filter((row) => {
      if (selectedSetupSection !== 'all' && row.section !== selectedSetupSection) {
        return false;
      }

      if (selectedSetupCategory !== 'all' && row.category !== selectedSetupCategory) {
        return false;
      }
