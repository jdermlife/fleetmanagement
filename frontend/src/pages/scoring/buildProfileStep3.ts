...
export const STEP_3_SECTIONS: Step3Section[] = [
...

  {
    ...
    fields: [
      ...
      { key: 'officePhoneNumber', label: 'Office Phone Number', type: 'tel' },
  ...
  },
  {
    ...
    fields: [
      { key: 'employmentLocation', label: 'Employment Location', type: 'select', options: ['Locally Employed', 'Not Locally Employed'] },
      { key: 'employerBusinessYears', label: 'Years in Business of Employer', type: 'number' },
      { key: 'mobileYearsUsed', label: 'Mobile Number Years in Use' },
      { key: 'emailYearsUsed', label: 'Email Address Years in Use' },
      { key: 'employmentReferencePerson', label: 'Employment Reference Person and Contact No.', type: 'textarea' },
      { key: 'hrContactInformation', label: 'HR Contact Information and Contact No.', type: 'textarea' },
      { key: 'supervisorInformation', label: 'Supervisor Information and Contact No.', type: 'textarea' },
      { key: 'sourceOfIncomeVerificationReferences', label: 'Source of Income Verification and Contact No.', type: 'textarea' },
      { key: 'lengthOfResidenceConfirmation', label: 'Length of Residence Confirmation', type: 'textarea' },
      { key: 'utilityAccountReferences', label: 'Utility Account References', type: 'textarea' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'characterReferences', label: 'Character References and CONTACT NUMBERS', type: 'textarea' },
      { key: 'guarantorReferences', label: 'Guarantor References and CONTACT NUMBERS', type: 'textarea' },
      { key: 'coBorrowerReferences', label: 'Co-Borrower References and CONTACT NUMBERS (Optional)', type: 'textarea' },
      { key: 'referencesFromEmployerOrCommunity', label: 'References from Employer or Community and CONTACT NUMBERS', type: 'textarea' },
