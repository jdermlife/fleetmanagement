...
export const STEP_3_SECTIONS: Step3Section[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'additionalPropertyDeclarations', label: 'Additional Property Declarations (Consolidate)' },
      { key: 'additionalVehicleDeclarations', label: 'Financial Investments (Consolidate)' },
