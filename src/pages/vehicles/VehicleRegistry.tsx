...
function VehicleRegistry({
  storageLabel = 'These records come from the backend API.',
  ...
  async function loadVehicles() {
    ...
    try {
      ...
      setError(
        getErrorMessage(
          error,
          'Unable to load vehicles right now. Check that the backend is running.',
        ),
      )
    } finally {
      setIsLoading(false)
  ...
  async function handleSubmit(
    ...
    try {
      if (
        ...
        setSuccessMessage(
          'Vehicle saved to the fleet registry.',
        )
      } else {
        const response =
  ...
  async function handleDelete(
    ...
    const confirmed =
      window.confirm(
        `Delete ${vehicle.make} ${vehicle.model} from the fleet registry?`,
      )
