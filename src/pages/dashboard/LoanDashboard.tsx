      ...
      {borrowers.map((b, i) => (
        <div key={i} className="mb-6 p-5 border border-gray-200 rounded-lg bg-gray-50/50 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <label className="block"><span className="block mb-1 font-medium text-xs text-gray-600 uppercase">Debt Service Ratio (DSR) %</span><input type="number" step="0.01" className="w-full p-2 rounded border border-gray-300 focus:ring-blue-500 focus:border-blue-500 text-sm" value={b.dsr_percent} onChange={e => updateBorrower(i, 'dsr_percent', parseFloat(e.target.value))} /></label>
