...
class User(Base):
	...
	apple_sign_in_disconnected_at = Column(DateTime(timezone=True))
	google_sign_in_disconnected_at = Column(DateTime(timezone=True))
...
class AuthSession(Base):
	...
	auth_provider = Column(String(20), index=True)
