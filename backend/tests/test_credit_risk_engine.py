...
class CreditRiskEngineTests(unittest.TestCase):
    def test_credit_risk_package_contains_expected_sections(self) -> None:
        ...
        self.assertEqual(result["credit_scores"]["total_credit_score"], 26.0)
        self.assertEqual(result["credit_scores"]["bureau_score"], 443.0)
        ...
        self.assertEqual(result["credit_bureau_reports"]["bureau_score"], 443.0)
